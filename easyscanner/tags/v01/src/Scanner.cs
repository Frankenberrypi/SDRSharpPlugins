...
namespace SDRSharp.Scanner
{
  ...
  public delegate void ScanNextFrequencyTimeLeft(double MilliSeconds, ScannerState State);
  ...
  class Scanner
  {
    ...
    private ScannerCompareMode _mode = ScannerCompareMode.Frequency;
    ...
    private void UpdateTimeLeft(int TimeMs)
    {
      if (_scanNextFrequencyTimeLeftCallBack != null)
      {
        ...
        _scanNextFrequencyTimeLeftCallBack(TimeMs, _scannerState);
      }
    }
